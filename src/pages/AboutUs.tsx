            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-10 mb-12">
                <div className="w-full md:w-1/2 bg-white rounded-xl shadow-sm border border-gray-100 p-6 animate-fade-up animation-delay-300">
                  <div className="flex items-center justify-center w-14 h-14 rounded-full bg-primary-muted text-primary mb-4 mx-auto">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-center">The Infrastructure Play</h3>
                ...
                <div className="w-full md:w-1/2 bg-white rounded-xl shadow-sm border border-gray-100 p-6 animate-fade-up animation-delay-400">
                  <div className="flex items-center justify-center w-14 h-14 rounded-full bg-primary-muted text-primary mb-4 mx-auto">
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-center">Beyond the Hype Cycle</h3>
                  <p className="text-muted-foreground text-center">
